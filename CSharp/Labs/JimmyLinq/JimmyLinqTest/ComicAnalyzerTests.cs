...
public class ComicAnalyzerTests
{
    ...
    public void ComicAnalyzerShouldGenerateAListOfReviews()
    {
        ...
        {
            "MuddyCritic rated #1 'Issue 1' 14,50", // NB: Boka bruker 14.50 som gjør at testen vil feile, så her er det endret til
                                                    // 14,50 slik at den vil fungere. Antar at det noe med lokalisering og kommaer.
    ...
    public void ComicAnalyzerShouldHandleWeirdReviewScores()
    {
        ...
        List<string> expectedResults = [
            "MuddyCritic rated #1 'Issue 1' -12,12", // Samme kommaproblem her...
